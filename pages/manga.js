  ...
  return (
    <>
      ...
      <Container fluid className="p-5 section">
        ...
        <p className="mb-4">If there&apos;s any dream of any animanga connoisseur or artist, it&apos;s to see all different kinds of physical copies of manga all in one place!
        ...
        <MyImage src="images/manga_library_program.jpg" alt="Manga Library photo" className="mw-100 border-stroke mx-auto d-block" />
      </Container>
    </>
  )
}
