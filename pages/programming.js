  ...
  return (
    <>
      ...
      <Container fluid className="p-5 section" id="main">
        ...
        <p className="mb-0">If you are a performer and are interested in performing at Animefest, please view our Performers application <a href="https://forms.gle/U5vXp6oN8YotrfzBA" className="highlight">here.</a> The deadline to apply is January 22nd.</p>
      </Container>

      <Container fluid className="p-5 mt-4 section" id="exhibitor">
        <h1 className="text-left mb-4 display-text">Exhibitor Hall</h1>
        <p>If you are interested in participating in our Artist Alley, please view our application <a href="https://forms.gle/kwaHKZfCBGKtAGZf6" className="highlight">here.</a></p>
        <p>If you are an industry vendor and are interested in having a presence at Animefest, please view our Vendors application <a href="https://forms.gle/PeRgEDPYgjWv4mtB7" className="highlight">here.</a></p>
      ...
      <Container fluid className="p-5 mt-4 section" id="theater">
