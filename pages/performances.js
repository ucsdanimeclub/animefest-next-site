    ...
    return (
        <>
            ...
            <Container fluid className="p-3 mt-4 section">
                ...
                {/*<p className="text-left caption-text mb-4">3:00 PM - 4:00 PM: Performance</p>*/}
                <p className="mb-4">We&apos;re an orchestra that plays music from video games, anime, film, and other pop
                    culture! We&apos;ll be performing select pieces from our upcoming Winter 2023 concert at Animefest.</p>
                <div className="video-player mx-auto">
                    <Ratio aspectRatio="16x9">
